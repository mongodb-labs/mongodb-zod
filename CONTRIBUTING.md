...
[creating a new issue](https://github.com/mongodb-labs/mongodb-zod/issues).
...
1. Run the [Prepare Release](https://github.com/mongodb-labs/mongodb-zod/actions/workflows/prepare-release.yml) workflow with the desired type of version bump (major, minor, patch) or an exact version.
...
1. Run the [Publish Release](https://github.com/mongodb-labs/mongodb-zod/actions/workflows/publish-release.yml) workflow from the release branch. This will publish the plugin to npm, merge the release PR, and create a new github release.
